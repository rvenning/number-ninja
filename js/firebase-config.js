// Shared family Firebase project (wordvoyage-e5a5c). Each game gets its own
// Firestore collection; Number Ninja uses "numberninja".
//
// This is a client config, not a secret — the key is restricted to the Cloud
// Firestore API and to the games' own origins.
